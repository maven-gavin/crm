package com.yuanbao.crm.common.entity.search.utils;
import com.google.common.collect.Lists;
import com.yuanbao.crm.common.entity.search.SearchOperator;
import com.yuanbao.crm.common.entity.search.Searchable;
import com.yuanbao.crm.common.entity.search.exception.InvalidSearchPropertyException;
import com.yuanbao.crm.common.entity.search.exception.InvalidSearchValueException;
import com.yuanbao.crm.common.entity.search.exception.SearchException;
import com.yuanbao.crm.common.entity.search.filter.AndCondition;
import com.yuanbao.crm.common.entity.search.filter.Condition;
import com.yuanbao.crm.common.entity.search.filter.OrCondition;
import com.yuanbao.crm.common.entity.search.filter.SearchFilter;
import com.yuanbao.crm.common.utils.SpringUtils;
...
public final class SearchableConvertUtils {
     ...
     * value="com.yuanbao.crm.common.entity.search.util.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.yuanbao.crm.common.entity.search.util." +
