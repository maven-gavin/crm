...
import com.yuanbao.crm.common.plugin.entity.Move;
import com.yuanbao.crm.common.test.BaseIT;
...
public class MoveServiceIT extends BaseIT {
    ...
    public void testSave() {
        ...
        assertEquals((Integer) (m1.getWeight() + moveService.getStepLength()), m2.getWeight());
    }
