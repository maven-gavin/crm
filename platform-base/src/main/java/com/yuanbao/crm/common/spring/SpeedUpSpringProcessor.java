package com.yuanbao.crm.common.spring;
...
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needLazyInit(String beanName) {
        ...
        for (String nonLazyBeanName : noneLazyBeanNames) {
            if (beanName.equals(nonLazyBeanName)) {
                return false;
            }
        }
        return true;
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if(className.equals("com.yuanbao.crm.common.repository.support.SimpleBaseRepositoryFactoryBean") ||
