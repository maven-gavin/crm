 ...
 * 具体使用请参考测试用例：{@see com.yuanbao.crm.common.repository.UserRepository}
 * <p/>
 * 想要使用该接口需要在spring配置文件的jpa:repositories中添加
 * factory-class="com.yuanbao.crm.common.repository.support.SimpleBaseRepositoryFactoryBean"
 * <p/>
